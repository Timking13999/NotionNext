...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'King', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '芳疗领航员', // 作者简介
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '陕ICP备2025061611号-1 陕公网安备61019002003286号', // 备案号 闽ICP备XXXXXX
